...
<body data-spy="scroll" data-target=".navbar-collapse">
                        ...
                        <div class="col-md-6">
                            <div class="navbar-callus text-left sm-text-center">
                                <ul class="list-inline">
                                    <li>
                                        <a href=""><i class="fa fa-phone"></i> Call us: 1234 5678 90</a>
                                    </li>
                                    <li>
                                        <a href=""><i class="fa fa-envelope-o"></i> Contact us:
                                            kursus@kita.com</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="navbar-socail text-right sm-text-center">
                                <ul class="list-inline">
                                    ...
                                    <li>
                                        <a href="https://youtube.com/@codeworshipper" target="_blank"><i
                        ...
                        <div class="col-md-6">
                            <div class="business_item sm-m-top-50">
                                ...
                                <div class="business_btn">
                                    ...
                                    <a href="#login" class="btn btn-primary m-top-20">Start Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="maine_action">
                        ...
                        <div class="col-md-4">
                            <div class="action_btn text-left sm-text-center">
                                <a href="https://www.youtube.com/@codeworshipper?sub_confirmation=1"
                                    class="btn btn-default" target="_blank">Subscribe Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="widget_area">
                        ...
                        <div class="col-md-3">
                            <div class="widget_item widget_service sm-m-top-50">
                                ...
                                <ul class="m-top-20">
                                    <li class="m-top-20">
                                        <a href="https://www.youtube.com/watch?v=tj2TJ66QRIo" target="_blank"><i
                                                class="fa fa-angle-right"></i> Chat App</a>
                                    </li>
                                    <li class="m-top-20">
                                        <a href="https://www.youtube.com/watch?v=YMj-tYrnOuQ" target="_blank"><i
                                                class="fa fa-angle-right"></i> Template Website
                                            Premium</a>
                                    </li>
                                    <li class="m-top-20">
                                        <a href="https://www.youtube.com/watch?v=QqOg2xQw2Yw" target="_blank"><i
                                                class="fa fa-angle-right"></i> Cara Hosting
                                            Website</a>
                                    </li>
                                    <li class="m-top-20">
                                        <a href="https://www.youtube.com/watch?v=51OqEADQfpQ" target="_blank"><i
                                                class="fa fa-angle-right"></i> Deploy Restfull
                                            API</a>
                                    </li>
                                    <li class="m-top-20">
                                        <a href="https://www.youtube.com/watch?v=dcCYgvZ_kxc" target="_blank"><i
                                                class="fa fa-angle-right"></i> Laravel Breeze</a>
                                    </li>
                                    <li class="m-top-20">
                                        <a href="https://www.youtube.com/watch?v=q_yJV1xElt0" target="_blank"><i
                                                class="fa fa-angle-right"></i> Membuat Web
                                            Autentikasi</a>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="main_footer fix bg-mega text-center p-top-40 p-bottom-30 m-top-80">
                <div class="col-md-12">
                    <p class="wow fadeInRight" data-wow-duration="1s">
                        ...
                        by
                        <a target="_blank" href="https://youtube.com/@codeworshipper">Code Worshipper</a>
    ...
    {{-- <script src="{{ asset('assets/js/owl.') }}js/owl.carousel.min.js"></script> --}}
