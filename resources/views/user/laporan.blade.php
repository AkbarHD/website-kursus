            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    @if ($isJadwal->isEmpty() || $laporan->isEmpty())
                        ...
                        <p class="mb-4">Anda saat ini <span class="text-danger">tidak memiliki</span> Laporan
                            kursus!. Anda bisa berjuang untuk mengikuti <span class="text-success">kursus</span>
                            terlebih dahulu! .</p>
                    @else
                        <h1 class="h3 mb-2 text-gray-800">Laporan Kursus Anda</h1>
                        <div class="d-sm-flex align-items-center justify-content-between mb-3">
                            <p class="mt-3">Anda bisa mencetak <span class="text-primary">Laporan Kursus</span> anda
                                di sini:</p>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="laporanKursus" width="100%"
                                        cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th>Name</th>
                        ...
                        @if ($isJadwal->isNotEmpty())
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="jadwalKursus" width="100%"
                                            cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>Kursus</th>
