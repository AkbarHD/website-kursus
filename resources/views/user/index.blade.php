                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-sewing-machine fa-2x text-gray-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="currentTime">
                                            </div>
                                        </div>
                                        <div class="col-auto">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('logout') }}" method="POST" style="display: inline">
                        @csrf
                        <button type="submit" class="bottom-9tn btn-primary">Logout</button>
                    </form>
                </div>
            </div>
        </div>
