                        ...
                        <form
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control bg-light border-0 small"
                                    placeholder="Cari untuk..." aria-label="Search" aria-describedby="basic-addon2" />
                                        ...
                                        <a class="dropdown-item d-flex align-items-center" href="#">
                                            ...
                                            <div>
                                                <div class="small text-gray-500">
                                                    {{ \Carbon\Carbon::parse($info->waktu)->format('F j, Y') }}</div>
                                                <span class="font-weight-bold">{{ $info->pesan }}</span>
                                            </div>
                                        </a>
                                    @empty
                                        <a class="dropdown-item text-center small text-gray-500" href="#">Tidak
                                            Ada
                                            Notif</a>
                                    @endforelse
                        ...
                        <div class="row">
                                ...
                                <div class="card shadow mb-4">
                                    @if ($isRegistered)
                                        ...
                                        <div class="card-body">
                                            ...
                                            Silahkan Cek <span class="text-success">pusat peringatan</span> secara
                                            berkala!
                                        </div>
                                    @else
                                        <div class="card-header py-3">
                                        ...
                                        <div class="card-body">
                                            <form id="registrationForm" action="{{ route('create') }}"
                                                method="POST">
                                                @csrf
                            ...
                            <div class="col-lg-6 mb-4">
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <p>Kursus Menjahit ini dirancang untuk pemula maupun yang sudah berpengalaman
                                            dalam
                                            menjahit. Anda akan belajar berbagai teknik dan desain yang bervariasi.</p>
